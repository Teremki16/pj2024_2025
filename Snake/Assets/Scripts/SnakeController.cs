...
public class SnakeController : MonoBehaviour
{
    ...
    private GameController conrtoller;
    ...
    private void Start()
    {
        ...
        stepRate = 0.3f;
        isFoodEaten = false;
        conrtoller = GameObject.Find("GameController").GetComponent<GameController>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.gameObject.name == "WallU" && currentAngle == 270f)
        {
