...
$(".start").on("click", ()=>{
    ...
    clock = setInterval(()=>{
        ...
        if(time <= 0){
            ...
            location.assign("../quiz1/index.html")
        }
    },1000)
})

let answers = [
    ["гарі","гаррі", "гаррі потер"],
    ["губка боб"],
    ["пірати корипського моря","джек"],
    ["сімпсони","барт"],["мисливці","мисливці на привидів"],
    ["імперський марш","зоряні війни"],
    ["король лев","сімба"],
    ["крижане сердце","ельза"],
    ["шрек","фіона"],
    ["рокі","сталоне"],
    ["один вдома","home alone"],
    ["індіана","індіана  джонсон"],
    ["назад в майбутне","макфайл","майбутне"],
