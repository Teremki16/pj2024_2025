...
public class Controller : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.E) && inventoryManager.inventoryPanel.activeSelf)
        {
            ...
            itemYouCanEquipName != EQUIPE_NOT_SELECTED_TEXT &&
    ...
    private void CreateBlock()
    {
        ...
        if(hit.transform.gameObject.tag == "Block")
        {
            ...
            {
                newBlockPoz = new Vector3(tempPos.x, tempPos.y + 1, tempPos.z);
            ...
            {
                newBlockPoz = new Vector3(tempPos.x, tempPos.y, tempPos.z + 1);
            }
            ...
            {
                newBlockPoz = new Vector3(tempPos.x + 1, tempPos.y, tempPos.z);
            }
