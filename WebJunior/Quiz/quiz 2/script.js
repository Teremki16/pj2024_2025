...
let answers = [
    ["мисливці", "мисливці на привидів"],
    ["гарі", "гаррі", "гаррі поттер"],
    ["губка боб", "спандж боб", "губка"],
    ["пірати", "пірати карибського моря", "джек"],
    ["сімпсони", "барт", "гомер"],
    ["імперський марш", "стар варс", "зоряні війни"],
    ["король лев", "лев", "сімба"],
    ["крижане серце", "фрозен", "ельза"],
    ["шрек", "фіона", "осел"],
    ["рокі", "сталоне"],
    ["індіана", "індіана джонс", "скарби"],
    ["один вдома", "сам вдома", "сам удома"],
    ["термінатор", "алл бі бек", "шварцнегер"],
    ["назад в майбутнє", "макфлай", "майбутнє"],
];
